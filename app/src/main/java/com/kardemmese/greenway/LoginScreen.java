        ...
        aLoignBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(password.length() < 6){
                    aPassword.setError("Your password must be at least 6 character long.");
                    return;
                }
                ...
                aAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()) {
                            Toast.makeText(LoginScreen.this, "Logged in succefcully.", Toast.LENGTH_LONG).show();
                            startActivity(new Intent(getApplicationContext(), HomePage.class));
                        }else{
                            Toast.makeText(LoginScreen.this, "Error !!!" + task.getException().getMessage(), Toast.LENGTH_LONG).show();
                        }
